  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await adminApi.delete(
        `/recruiters/${selectedRecruiter._id}`,
      );
      if (response.data.success) {
        notifications.show({
          title: "Success",
    ...
    <Container size="xl" className="py-8">
              ...
              {recruiters.length === 0 ? (
                ...
                recruiters.map((recruiter) => (
                  <Table.Tr key={recruiter._id}>
                    ...
                    <Table.Td>
                      <Badge
                        color={recruiter.isActive !== false ? "green" : "red"}
                      >
      ...
      >
        {selectedRecruiter && (
          <Stack gap="md">
            ...
            <Divider />
            <div>
              <Text fw={600}>Jobs Posted:</Text>
              <Text>{selectedRecruiter.jobCount}</Text>
            </div>
            <div>
      ...
      >
        <Alert color="red" mb="md">
          ...
          <strong>{selectedRecruiter?.fullName}</strong>? This will also delete
          all jobs posted by this recruiter and all applications for those jobs.
        </Alert>
