...
// import { IconTrash, IconPlus, IconMail, IconShield } from '@tabler/icons-react';
...
//                   <Table.Td>
//                     <Group gap="sm">
//                       <Avatar size="sm" radius="xl" color={getRoleBadgeColor(admin.role)}>
...
//                   <Table.Td>
//                     <Badge color={getRoleBadgeColor(admin.role)}>
//                       {admin.role.toUpperCase()}
//                     </Badge>
//                   </Table.Td>
//                   <Table.Td>
//                     <Group gap="xs">
//                       {admin.permissions.canManageCandidates && <Badge size="sm">Candidates</Badge>}
//                       {admin.permissions.canManageRecruiters && <Badge size="sm">Recruiters</Badge>}
//                       {admin.permissions.canManageJobs && <Badge size="sm">Jobs</Badge>}
//                       {admin.permissions.canDeleteData && <Badge size="sm" color="red">Delete</Badge>}
//                     </Group>
//                   </Table.Td>
//                   <Table.Td>
...
//                 checked={formData.permissions.canManageCandidates}
//                 onChange={(e) => setFormData({
//                   ...formData,
//                   permissions: { ...formData.permissions, canManageCandidates: e.currentTarget.checked }
//                 })}
//               />
//               <Switch
//                 label="Manage Recruiters"
//                 checked={formData.permissions.canManageRecruiters}
//                 onChange={(e) => setFormData({
//                   ...formData,
//                   permissions: { ...formData.permissions, canManageRecruiters: e.currentTarget.checked }
//                 })}
//               />
//               <Switch
//                 label="Manage Jobs"
//                 checked={formData.permissions.canManageJobs}
//                 onChange={(e) => setFormData({
//                   ...formData,
//                   permissions: { ...formData.permissions, canManageJobs: e.currentTarget.checked }
//                 })}
//               />
//               <Switch
//                 label="Manage Applications"
//                 checked={formData.permissions.canManageApplications}
//                 onChange={(e) => setFormData({
//                   ...formData,
//                   permissions: { ...formData.permissions, canManageApplications: e.currentTarget.checked }
//                 })}
//               />
//               <Switch
//                 label="Delete Data"
...
//                 onChange={(e) => setFormData({
//                   ...formData,
//                   permissions: { ...formData.permissions, canDeleteData: e.currentTarget.checked }
//                 })}
//               />
//             </Stack>
//           </div>
...
//           <Button color="red" onClick={handleDeleteAdmin}>Delete</Button>
//         </Group>
//       </Modal>
//     </Container>
//   );
