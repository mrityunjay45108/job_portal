...
//       {/* Header */}
//       <div className="mb-6">
//         <Title order={2} className="text-gray-900">System Health & Statistics</Title>
//         <Text className="text-gray-500">Monitor system performance and resource usage</Text>
//       </div>
...
//               <div>
//                 <Text fw={700} size="lg">Server Status</Text>
//                 <Text size="xs" className="text-gray-500">System health metrics</Text>
//               </div>
...
//               <div className="flex justify-between items-center">
//                 <Text size="sm" fw={500}>Node.js Version</Text>
...
//             <Group justify="space-between" mb="md">
//               <div>
//                 <Text fw={700} size="lg">Database Status</Text>
//                 <Text size="xs" className="text-gray-500">MongoDB metrics</Text>
//               </div>
...
//               <div className="flex justify-between items-center">
//                 <Text size="sm" fw={500}>Indexes</Text>
...
//             <Group justify="space-between" mb="md">
//               <div>
//                 <Text fw={700} size="lg">Storage Status</Text>
//                 <Text size="xs" className="text-gray-500">Cloudinary & local storage</Text>
//               </div>
//               <IconHardDrive size={28} className="text-purple-600" />
//             </Group>
//             <Divider mb="md" />
...
//                   <Text size="sm">{stats.storage.used} / {stats.storage.total}</Text>
//                 </div>
//                 <Progress 
//                   value={parseInt(stats.storage.used) / parseInt(stats.storage.total) * 100} 
//                   color="blue" 
//                   size="md" 
//                   radius="xl"
//                 />
...
//             <Group justify="space-between" mb="md">
//               <div>
//                 <Text fw={700} size="lg">API Performance</Text>
//                 <Text size="xs" className="text-gray-500">Endpoint metrics and response times</Text>
//               </div>
...
//                 <Text size="xs" className="text-gray-500">Total Requests (30d)</Text>
//                 <Text fw={700} size="xl">{stats.api.totalRequests.toLocaleString()}</Text>
//               </div>
//               <div className="text-center p-3 bg-gray-50 rounded-lg">
//                 <Text size="xs" className="text-gray-500">Avg Response Time</Text>
//                 <Text fw={700} size="xl">{stats.api.avgResponseTime}ms</Text>
//               </div>
//               <div className="text-center p-3 bg-gray-50 rounded-lg">
//                 <Text size="xs" className="text-gray-500">Success Rate</Text>
//                 <Text fw={700} size="xl">{stats.api.successRate}%</Text>
//                 <RingProgress
//                   size={80}
//                   thickness={6}
...
//                       <Table.Td className="text-center">
//                         <Badge 
//                           color={endpoint.avgTime < 100 ? 'green' : endpoint.avgTime < 300 ? 'yellow' : 'red'} 
//                           variant="light"
//                         >
//                           {endpoint.avgTime}ms
//                         </Badge>
...
const SystemStats = () => {
  ...
  const loadSystemStats = async (silent: boolean = false) => {
    ...
    try {
      ...
      const [serverStats, dbStats, apiStats, storageStats, activityStats] = await Promise.all([
  ...
  const getActiveUsers = async () => {
    try {
      ...
      return response.data.stats?.totalCandidates + response.data.stats?.totalRecruiters || 234;
    } catch {
      return 234;
    }
  };
  ...
  if (!stats) {
    return (
      <Container size="xl" className="py-8">
        ...
        <Button onClick={refreshStats} mt="md" leftSection={<IconRefresh size={16} />}>
          Try Again
        </Button>
      </Container>
    );
        ...
        <Grid.Col span={{ base: 12, md: 6, lg: 4 }}>
          <Card className="bg-white border border-gray-200 rounded-xl shadow-sm" p="lg">
            <Group justify="space-between" mb="md">
              <div>
                <Text fw={700} size="lg">Storage Status</Text>
                <Text size="xs" className="text-gray-500">Storage metrics</Text>
              </div>
            ...
            <Stack gap="md">
              <div>
                <div className="flex justify-between items-center mb-1">
                  <Text size="sm" fw={500}>Storage Used</Text>
                  <Text size="sm">{stats.storage.used} GB / {stats.storage.total} GB</Text>
                </div>
                <Progress 
                  value={(parseFloat(stats.storage.used) / parseFloat(stats.storage.total)) * 100} 
                  color="blue" 
                  size="md" 
                  radius="xl"
                />
