  ...
  return (
    ...
    >
      <div className="flex justify-between items-start">
        ...
        <div className={`p-3 ${getColorClass()} rounded-xl`}>{icon}</div>
      </div>
    </Card>
  );
};
  ...
  const loadReports = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        try {
          const statusResponse = await adminApi.get(
    ...
    <Container size="xl" className="py-8">
      <div className="mb-6">
        ...
        <Text className="text-gray-500">
          Track platform performance and hiring metrics
        </Text>
      </div>
            ...
            <Group justify="space-between" mb="md">
              <div>
                ...
                <Text size="xs" className="text-gray-500">
                  Jobs, Applications & Hires over time
                </Text>
              </div>
              ...
              {reportData.monthlyData.map((item, idx) => {
                ...
                return (
                  <div key={idx}>
                    ...
                    <div className="space-y-2">
                      ...
                      <div>
                        ...
                        <SimpleProgress
                          value={
                            maxValue > 0
                              ? ((item.applications || 0) / maxValue) * 100
                              : 0
                          }
                          color="green"
                          size="sm"
                    ...
                    {idx < reportData.monthlyData.length - 1 && (
          ...
          >
            ...
            <div className="space-y-4">
              {reportData.statusDistribution.map((status, idx) => {
                ...
                const percentage =
                  total > 0 ? ((status.value || 0) / total) * 100 : 0;
                  ...
                  <div key={idx}>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-semibold">
                        {status.value || 0} ({percentage.toFixed(0)}%)
                      </span>
                    </div>
                    <SimpleProgress
                      value={percentage}
          ...
          >
            <Group justify="space-between" mb="md">
              <div>
                ...
                <Text size="xs" className="text-gray-500">
                  Companies with most job posts and hires
                </Text>
              </div>
              ...
              <Table>
                ...
                <Table.Tbody>
                  {reportData.topCompanies.map((company, idx) => {
                    const successRate =
                      company.jobs > 0
                        ? ((company.hires || 0) / company.jobs) * 100
                        : 0;
                    return (
                      <Table.Tr key={idx}>
