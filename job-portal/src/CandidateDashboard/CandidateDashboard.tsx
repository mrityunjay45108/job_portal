...
//         color: "blue",
//         label: "APPLIED",
//         icon: <IconSend size={12} key="send-icon" />,
//       },
//       reviewing: {
//         color: "yellow",
//         label: "UNDER REVIEW",
//         icon: <IconClock size={12} key="clock-icon" />,
//       },
//       shortlisted: {
//         color: "green",
//         label: "SHORTLISTED",
//         icon: <IconStar size={12} key="star-icon" />,
//       },
//       interview: {
//         color: "orange",
//         label: "INTERVIEW",
//         icon: <IconCalendar size={12} key="calendar-icon" />,
//       },
//       rejected: {
//         color: "red",
//         label: "REJECTED",
//         icon: <IconX size={12} key="x-icon" />,
//       },
//       hired: {
//         color: "teal",
//         label: "HIRED! 🎉",
//         icon: <IconAward size={12} key="award-icon" />,
//       },
//     };
//     const c = config[status];
//     return c ? (
//       <Badge color={c.color} size="sm" leftSection={c.icon} key={status}>
//         {c.label}
//       </Badge>
//     ) : (
//       <Badge color="gray" size="sm" key={status}>
//         {status.toUpperCase()}
//       </Badge>
//     );
//   };
...
//           >
//             {[1, 2, 3, 4].map((i) => (
//               <Skeleton key={`skeleton-${i}`} height={100} radius="xl" />
//             ))}
//           </SimpleGrid>
...
//   const mobileTabs = [
//     { value: "overview", label: "Home", icon: <IconTrendingUp size={18} key="home-icon" /> },
//     { value: "jobs", label: "Jobs", icon: <IconSearch size={18} key="jobs-icon" /> },
//     { value: "applications", label: "Apps", icon: <IconBriefcase size={18} key="apps-icon" /> },
//     { value: "profile", label: "Profile", icon: <IconUser size={18} key="profile-icon" /> },
//     { value: "notifications", label: "Alerts", icon: <IconBell size={18} key="alerts-icon" /> },
//   ];
...
//             </div>
//             <div>
//               <Text size="xs" className="text-blue-600 font-semibold">
//                 Dashboard
//               </Text>
//               <Text size="sm" fw={700}>
//                 Hi, {getFirstName()}!
...
//         {/* Stats Cards - Responsive Grid with keys */}
//         <SimpleGrid
...
//                   Total Apps
//                 </Text>
//                 <Text size="28px" fw={800} className="text-2xl sm:text-3xl">
//                   {stats.totalApplied}
//                 </Text>
//               </div>
//               <div className="p-2 bg-white/20 rounded-xl">
//                 <IconBriefcase size={20} className="sm:size-[24px]" />
//               </div>
//             </div>
//           </Card>
...
//               </div>
//               <div className="p-2 bg-white/20 rounded-xl">
//                 <IconStar size={20} className="sm:size-[24px]" />
//               </div>
//             </div>
//           </Card>
...
//               </div>
//               <div className="p-2 bg-white/20 rounded-xl">
//                 <IconCalendar size={20} className="sm:size-[24px]" />
//               </div>
//             </div>
//           </Card>
...
//               </div>
//               <div className="p-2 bg-white/20 rounded-xl">
//                 <IconAward size={20} className="sm:size-[24px]" />
//               </div>
//             </div>
//           </Card>
//         </SimpleGrid>

//         {/* Profile Strength - Responsive */}
...
//                 label={
//                   <Text size="sm" fw={800} className="text-blue-600">
//                     {profileCompletion}%
//                   </Text>
//                 }
//               />
...
//               className={`flex flex-col items-center gap-0.5 py-1 px-2 rounded-lg transition-all ${activeTab === tab.value ? "text-blue-600" : "text-gray-500"}`}
//             >
//               {tab.icon}
//               <span className="text-[10px] font-medium">{tab.label}</span>
//               {tab.value === "notifications" && unreadCount > 0 && (
//                 <span className="absolute -top-0.5 right-1/4 w-3 h-3 bg-red-500 rounded-full text-white text-[8px] flex items-center justify-center">
//                   {unreadCount}
//                 </span>
//               )}
//             </button>
...
//           {/* Mobile Content - Show based on activeTab */}
...
//                     <Paper
//                       key={job.id}
//                       className="p-3 bg-gray-50 rounded-xl mb-2 cursor-pointer"
//                       onClick={() => {
//                         setSelectedJob(job);
//                         openApplyModal();
//                       }}
...
//                     <div
//                       key={app.id}
//                       className="flex justify-between items-center p-2 bg-gray-50 rounded-lg mb-2"
//                     >
//                       <div>
//                         <Text fw={500} size="sm">
//                           {app.jobTitle}
...
//                   {paginatedJobs.slice(0, 5).map((job) => (
//                     <Card
//                       key={job.id}
...
//                           size="xs"
//                           radius="xl"
//                           variant={isJobApplied(job.id) ? "filled" : "light"}
//                           color="blue"
//                           onClick={() => {
//                             setSelectedJob(job);
//                             openApplyModal();
...
//               <div className="space-y-3" key="mobile-apps">
//                 {applications.length === 0 ? (
//                   <div className="text-center py-8">
//                     <Text size="sm">No applications yet</Text>
//                     <Button
//                       size="xs"
...
//             {activeTab === "profile" && (
//               <div className="space-y-3" key="mobile-profile">
//                 <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
//                   <Avatar size={50} radius="xl" color="blue">
//                     {profile.fullName.charAt(0)}
//                   </Avatar>
//                   <div>
//                     <Text fw={600}>{profile.fullName}</Text>
//                     <Text size="xs" c="gray">
//                       {profile.email}
//                     </Text>
...
//               <div className="space-y-2" key="mobile-notif">
...
//                     <div
//                       key={notif.id}
//                       className={`p-3 rounded-xl ${notif.read ? "bg-white border border-gray-200" : "bg-blue-50 border border-blue-200"}`}
//                     >
//                       <div className="flex gap-2">
...
//                         <Paper
//                           key={job.id}
//                           className="p-3 md:p-4 bg-gray-50 rounded-xl mb-2 hover:shadow-md transition cursor-pointer"
//                           onClick={() => {
//                             setSelectedJob(job);
//                             openApplyModal();
//                           }}
...
//                             <div>
//                               <Text fw={600} size="sm md:text-base">
//                                 {job.jobTitle}
//                               </Text>
//                               <Text size="xs md:text-sm" c="gray">
//                                 {job.company} • {job.location}
//                               </Text>
//                             </div>
...
//                       <Card
//                         key={job.id}
//                         className="border border-gray-100 rounded-xl hover:shadow-xl transition-all p-3"
//                       >
//                         <div className="flex justify-between items-start">
//                           <div
...
//                             <IconChartBar size={12} className="text-blue-500" />
//                             <span className="text-xs">{matchScore}% match</span>
//                           </div>
//                           <Button
//                             size="xs"
//                             radius="xl"
...
//                       <IconBriefcase size={28} className="text-gray-400" />
//                     </div>
//                     <Text size="md" fw={500}>
//                       No applications yet
//                     </Text>
...
//                     <Card
//                       key={app.id}
//                       className="border border-gray-200 rounded-xl p-3 md:p-4 mb-3 hover:shadow-md transition"
//                     >
//                       <div className="flex flex-wrap justify-between items-start gap-2">
//                         <div>
//                           <Text fw={600} size="sm md:text-base">
...
//                     <Card
//                       key={interview.id}
//                       className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-3 mb-3"
//                     >
...
//                               key={`meeting-link-${interview.id}`}
//                             >
//                               Join Meeting <IconArrowRight size={10} />
//                             </a>
//                           )}
//                         </div>
//                       </div>
...
//                       <Button size="xs" variant="subtle" onClick={markAllRead} key="mark-all-read">
//                         Mark all as read
//                       </Button>
//                     </div>
...
//                       <div
//                         key={notif.id}
//                         className={`p-3 rounded-xl cursor-pointer transition ${notif.read ? "bg-white border border-gray-200" : "bg-blue-50 border border-blue-200"}`}
//                         onClick={() => markNotificationRead(notif.id)}
//                       >
//                         <div className="flex gap-3">
//                           <div
//                             className={`p-1.5 rounded-lg ${notif.type === "interview" ? "bg-orange-100" : "bg-blue-100"}`}
//                           >
...
//                               />
//                             ) : (
//                               <IconSend size={14} className="text-blue-600" />
//                             )}
//                           </div>
//                           <div>
//                             <Text fw={500} size="sm">
...
//                     <Badge key={`${selectedJob.id}-skill-${idx}`} variant="light" color="blue" size="sm">
//                       {s}
//                     </Badge>
//                   ))}
//                 </div>
...
//           {selectedJob && (
//             <div className="space-y-3">
//               <Alert icon={<IconRobot size={14} />} color="blue">
//                 Your skills match{" "}
...
//               />
//               <div className="flex gap-3">
//                 <Button onClick={handleApply} className="flex-1 bg-green-600" key="submit-application">
//                   Submit Application
//                 </Button>
//                 <Button onClick={closeApplyModal} variant="light" key="cancel-application">
//                   Cancel
//                 </Button>
//               </div>
//             </div>
...
//     } catch (error) {
//       console.error("Error loading applications:", error);
//       // Fallback data for development when backend is down
//       setApplications([]);
//     }
//   };
...
//   const mobileTabs = [
//     { value: "overview", label: "Home", icon: <IconTrendingUp size={18} /> },
//     { value: "jobs", label: "Jobs", icon: <IconSearch size={18} /> },
//     { value: "applications", label: "Apps", icon: <IconBriefcase size={18} /> },
//     { value: "profile", label: "Profile", icon: <IconUser size={18} /> },
//     { value: "notifications", label: "Alerts", icon: <IconBell size={18} /> },
//   ];
...
//           </div>
//           <div className="flex gap-2">
//             <Button variant="light" size="compact-sm" onClick={() => setProfileModalOpen(true)}>
//               <IconUser size={16} />
//             </Button>
//             <Button variant="light" size="compact-sm" onClick={handleLogout} color="red">
//               <IconLogout size={16} />
//             </Button>
//           </div>
//         </div>
...
//           <Card key="stat-shortlisted" className="bg-gradient-to-br from-emerald-500 to-teal-600 text-white rounded-xl shadow-lg p-3 sm:p-4">
//             <div className="flex justify-between items-center">
//               <div><Text size="xs" opacity={0.8}>Shortlisted</Text><Text size="28px" fw={800} className="text-2xl sm:text-3xl">{stats.shortlisted}</Text></div>
//               <div className="p-2 bg-white/20 rounded-xl"><IconStar size={20} className="sm:size-[24px]" /></div>
//             </div>
//           </Card>
//           <Card key="stat-interviews" className="bg-gradient-to-br from-orange-500 to-red-500 text-white rounded-xl shadow-lg p-3 sm:p-4">
//             <div className="flex justify-between items-center">
//               <div><Text size="xs" opacity={0.8}>Interviews</Text><Text size="28px" fw={800} className="text-2xl sm:text-3xl">{stats.interviews}</Text></div>
//               <div className="p-2 bg-white/20 rounded-xl"><IconCalendar size={20} className="sm:size-[24px]" /></div>
//             </div>
//           </Card>
//           <Card key="stat-success" className="bg-gradient-to-br from-purple-500 to-pink-500 text-white rounded-xl shadow-lg p-3 sm:p-4">
//             <div className="flex justify-between items-center">
//               <div><Text size="xs" opacity={0.8}>Success Rate</Text><Text size="28px" fw={800} className="text-2xl sm:text-3xl">{stats.totalApplied ? Math.round((stats.hired / stats.totalApplied) * 100) : 0}%</Text></div>
//               <div className="p-2 bg-white/20 rounded-xl"><IconAward size={20} className="sm:size-[24px]" /></div>
//             </div>
//           </Card>
//         </SimpleGrid>
...
//           <div className="p-3 sm:p-4 flex flex-col sm:flex-row justify-between items-center gap-4">
//             <div className="flex-1 text-center sm:text-left">
//               <div className="flex items-center justify-center sm:justify-start gap-2 mb-1"><IconShield size={18} className="text-blue-600" /><Text fw={700} size="sm">Profile Strength</Text></div>
//               <Text size="xs" className="text-gray-600">Complete your profile to get better job matches</Text>
//               <div className="mt-2 max-w-full sm:max-w-md"><Progress value={profileCompletion} color="blue" size="sm" radius="xl" /></div>
//             </div>
...
//                 <div>
//                   <div className="flex items-center gap-2 mb-3"><div className="p-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg"><IconRobot size={16} className="text-white" /></div><h2 className="text-base font-semibold">AI Recommended Jobs</h2></div>
//                   {recommendedJobs.slice(0, 3).map((job) => (
//                     <Paper key={job.id} className="p-3 bg-gray-50 rounded-xl mb-2 cursor-pointer" onClick={() => { setSelectedJob(job); openApplyModal(); }}>
//                       <Text fw={600} size="sm">{job.jobTitle}</Text>
//                       <Text size="xs" c="gray">{job.company} • {job.location}</Text>
//                       <Badge color="green" size="xs">{calculateMatchScore(job)}% Match</Badge>
//                     </Paper>
//                   ))}
//                 </div>
//                 <div>
//                   <div className="flex items-center gap-2 mb-3"><div className="p-1.5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg"><IconClock size={16} className="text-white" /></div><h2 className="text-base font-semibold">Recent Activity</h2></div>
//                   {applications.slice(0, 3).map((app) => (
...
//                   <div className="flex gap-2">
//                     <Select placeholder="Location" data={["Remote", "New York", "London"]} value={filterLocation} onChange={setFilterLocation} clearable size="xs" radius="xl" className="flex-1" />
//                     <Select placeholder="Type" data={["Full-time", "Part-time"]} value={filterJobType} onChange={setFilterJobType} clearable size="xs" radius="xl" className="flex-1" />
//                   </div>
//                 </div>
//                 <div className="space-y-3">
//                   {paginatedJobs.slice(0, 5).map((job) => (
...
//                       <div className="flex justify-between items-start">
//                         <div><Text fw={600} size="sm">{job.jobTitle}</Text><Text size="xs" c="gray">{job.company}</Text></div>
//                         <Button size="xs" radius="xl" variant={isJobApplied(job.id) ? "filled" : "light"} color="blue" onClick={() => { setSelectedJob(job); openApplyModal(); }} disabled={isJobApplied(job.id)}>{isJobApplied(job.id) ? "Applied" : "Apply"}</Button>
//                       </div>
//                       <div className="flex gap-2 mt-1">
//                         <Badge key={`${job.id}-type`} size="xs" variant="light">{job.jobType}</Badge>
//                         <Badge key={`${job.id}-salary`} size="xs" variant="light">{job.salary}</Badge>
//                       </div>
//                     </Card>
//                   ))}
//                 </div>
//                 {totalPages > 1 && <div className="mt-4 flex justify-center"><Pagination total={totalPages} value={currentPage} onChange={setCurrentPage} size="sm" /></div>}
//               </div>
//             )}

//             {activeTab === "applications" && (
//               <div className="space-y-3">
//                 {applications.length === 0 ? <div className="text-center py-8"><Text size="sm">No applications yet</Text><Button size="xs" onClick={() => setActiveTab("jobs")} className="mt-2">Browse Jobs</Button></div> : applications.map((app) => (
//                   <Card key={app.id} className="border border-gray-200 rounded-xl p-3">
//                     <div className="flex justify-between items-start">
//                       <div><Text fw={600} size="sm">{app.jobTitle}</Text><Text size="xs" c="gray">{app.company}</Text><Text size="xs" c="gray">Applied: {new Date(app.appliedDate).toLocaleDateString()}</Text></div>
//                       {getStatusBadge(app.status)}
//                     </div>
...
//               <div className="space-y-3">
//                 <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl">
//                   <Avatar size={50} radius="xl" color="blue">{profile.fullName.charAt(0)}</Avatar>
//                   <div><Text fw={600}>{profile.fullName}</Text><Text size="xs" c="gray">{profile.email}</Text><Badge size="xs" color="blue">{user?.role || "Candidate"}</Badge></div>
//                 </div>
...
//                 <Button variant="light" fullWidth onClick={() => setProfileModalOpen(true)} size="xs">Edit Profile</Button>
//                 <Button variant="light" color="red" fullWidth onClick={handleLogout} size="xs">Logout</Button>
//               </div>
//             )}

//             {activeTab === "notifications" && (
//               <div className="space-y-2">
//                 {notificationsList.length === 0 ? <div className="text-center py-8"><Text size="sm">No notifications</Text></div> : notificationsList.slice(0, 10).map((notif) => (
...
//                   <Grid.Col span={{ base: 12, md: 6 }}>
//                     <div className="flex items-center gap-2 mb-4 pb-2 border-b border-gray-200">
//                       <div className="p-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg"><IconRobot size={18} className="text-white" /></div>
//                       <h2 className="text-base md:text-lg font-semibold">AI Recommended Jobs</h2>
//                     </div>
...
//                         <div className="flex flex-wrap justify-between items-start gap-2">
//                           <div><Text fw={600} size="sm md:text-base">{job.jobTitle}</Text><Text size="xs md:text-sm" c="gray">{job.company} • {job.location}</Text></div>
//                           <Badge color="green" size="sm">{calculateMatchScore(job)}% Match</Badge>
//                         </div>
...
//                   <Grid.Col span={{ base: 12, md: 6 }}>
//                     <div className="flex items-center gap-2 mb-4 pb-2 border-b border-gray-200">
//                       <div className="p-1.5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg"><IconClock size={18} className="text-white" /></div>
...
//                         </div>
//                         <div className="flex gap-2 mt-2 flex-wrap">
//                           <Badge size="xs" variant="light">{job.jobType}</Badge>
//                           <Badge size="xs" variant="light">{job.salary}</Badge>
//                         </div>
//                         <div className="flex flex-wrap gap-1 mt-2">
//                           {job.skills?.slice(0, 2).map((s, idx) => (<Badge key={`${job.id}-skill-${idx}-${s}`} size="xs" variant="light" color="gray">{s}</Badge>))}
//                         </div>
//                         <div className="mt-3 flex justify-between items-center">
//                           <div className="flex items-center gap-1"><IconChartBar size={12} className="text-blue-500" /><span className="text-xs">{matchScore}% match</span></div>
//                           <Button size="xs" radius="xl" variant={applied ? "filled" : "gradient"} gradient={{ from: "blue", to: "indigo" }} onClick={() => { setSelectedJob(job); openApplyModal(); }} disabled={applied} className={applied ? "bg-green-600" : ""}>{applied ? "Applied" : "Apply"}</Button>
//                         </div>
//                       </Card>
//                     );
//                   })}
...
//                     <div className="flex gap-3">
//                       <div className="p-2 bg-blue-100 rounded-lg"><IconCalendar size={20} className="text-blue-600" /></div>
//                       <div><Text fw={600} size="sm">{interview.jobTitle}</Text><Text size="xs" c="gray">{interview.company}</Text><div className="flex flex-wrap gap-1 mt-1"><Badge size="xs" color="blue">{interview.date}</Badge><Badge size="xs" color="gray">{interview.time}</Badge></div>{interview.link && <a href={interview.link} target="_blank" className="text-blue-600 text-xs inline-flex items-center gap-1 mt-1">Join Meeting <IconArrowRight size={10} /></a>}</div>
//                     </div>
//                   </Card>
//                 ))}
//               </Tabs.Panel>
...
//           </div>
//           <SimpleGrid cols={{ base: 1, sm: 2, lg: 4 }} spacing="md" className="mb-6">
//             {[1, 2, 3, 4].map((i) => (<Skeleton key={`skeleton-${i}`} height={100} radius="xl" />))}
//           </SimpleGrid>
//           <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
//             <Skeleton height={400} radius="xl" className="lg:col-span-2" />
//             <Skeleton height={400} radius="xl" />
...
//             {activeTab === "overview" && (
//               <div className="space-y-4">
//                 <div><div className="flex items-center gap-2 mb-3"><div className="p-1.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg"><IconRobot size={16} className="text-white" /></div><h2 className="text-base font-semibold">AI Recommended Jobs</h2></div>
//                 {recommendedJobs.slice(0, 3).map((job) => (
//                   <Paper key={job.id} className="p-3 bg-gray-50 rounded-xl mb-2 cursor-pointer" onClick={() => { setSelectedJob(job); openApplyModal(); }}>
...
//                   </Paper>
//                 ))}</div>
//                 <div><div className="flex items-center gap-2 mb-3"><div className="p-1.5 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg"><IconClock size={16} className="text-white" /></div><h2 className="text-base font-semibold">Recent Activity</h2></div>
//                 {applications.slice(0, 3).map((app) => (
//                   <div key={app.id} className="flex justify-between items-center p-2 bg-gray-50 rounded-lg mb-2">
//                     <div><Text fw={500} size="sm">{app.jobTitle}</Text><Text size="xs" c="gray">{app.company}</Text></div>
//                     {getStatusBadge(app.status)}
...
//             {activeTab === "applications" && (
//               <div className="space-y-3">{applications.length === 0 ? <div className="text-center py-8"><Text size="sm">No applications yet</Text><Button size="xs" onClick={() => setActiveTab("jobs")} className="mt-2">Browse Jobs</Button></div> : applications.map((app) => (
//                 <Card key={app.id} className="border border-gray-200 rounded-xl p-3">
...
//             {activeTab === "notifications" && (
//               <div className="space-y-2">{notificationsList.length === 0 ? <div className="text-center py-8"><Text size="sm">No notifications</Text></div> : notificationsList.slice(0, 10).map((notif) => (
//                 <div key={notif.id} className={`p-3 rounded-xl ${notif.read ? "bg-white border border-gray-200" : "bg-blue-50 border border-blue-200"}`}>
//                   <div className="flex gap-2"><div className="p-1.5 bg-blue-100 rounded-lg"><IconSend size={14} /></div><div><Text fw={500} size="xs">{notif.title}</Text><Text size="xs" c="gray">{notif.message}</Text></div></div>
//                 </div>
//               ))}</div>
...
//               <div className="grid grid-cols-2 gap-2 text-sm"><div><strong>Salary:</strong> {selectedJob.salary}</div><div><strong>Experience:</strong> {selectedJob.experience}</div></div>
//               <div><strong>Description:</strong><p className="text-sm text-gray-700 mt-1">{selectedJob.description}</p></div>
//               <div><strong>Skills:</strong><div className="flex flex-wrap gap-1 mt-1">{selectedJob.skills?.map((s, idx) => (<Badge key={`modal-skill-${idx}`} variant="light" color="blue" size="sm">{s}</Badge>))}</div></div>
//               <div className="flex gap-3 mt-3"><Button color="blue" className="flex-1" onClick={() => { closeJobDetailsModal(); openApplyModal(); }} disabled={isJobApplied(selectedJob.id)}>{isJobApplied(selectedJob.id) ? "Already Applied" : "Apply Now"}</Button><Button variant="light" color="yellow" onClick={() => handleSaveJob(selectedJob)}>{isJobSaved(selectedJob.id) ? "Saved" : "Save Job"}</Button></div>
//             </div>
//           )}
//         </Modal>
