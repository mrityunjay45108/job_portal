...
// Fixed: Correct path to AuthContext (go up 2 levels to src, then into context)
import { useAuth } from "../../context/AuthContext";
// Fixed: Correct path to api (go up 2 levels to src, then into services)
...
//   NumberInput, Container, ThemeIcon, Grid, Alert
// } from "@mantine/core";
// import {
...
//       // Create complete job description with all sections
//       const fullDescription = `
// ${values.overview}

// **Key Responsibilities:**
// ${values.responsibilities.map(resp => `• ${resp}`).join('\n')}

// **Qualifications:**
// ${values.qualifications.map(qual => `• ${qual}`).join('\n')}

// **Benefits & Perks:**
// ${values.benefits.map(benefit => `• ${benefit}`).join('\n')}

// ${values.remotePolicy ? `**Remote Policy:**\n${values.remotePolicy}` : ''}
//       `.trim();
...
//                       </Badge>
//                       <Badge color="orange" variant="light" size="lg">
//                         <div className="flex items-center gap-1"><IconCurrencyDollar size={14} /> ${form.values.salaryMin?.toLocaleString()} - ${form.values.salaryMax?.toLocaleString()} / {form.values.salaryType}</div>
//                       </Badge>
//                       <Badge color="purple" variant="light" size="lg">
//                         <div className="flex items-center gap-1"><IconCertificate size={14} /> {form.values.experience || "Not specified"}</div>
//                       </Badge>
//                     </div>
...
//                         <div className="flex flex-wrap gap-2">
//                           {form.values.skills.slice(0, 5).map((skill, idx) => (
//                             <Badge key={idx} size="sm" variant="outline" color="blue">{skill}</Badge>
//                           ))}
//                           {form.values.skills.length > 5 && (
//                             <Badge size="sm" variant="outline" color="gray">+{form.values.skills.length - 5} more</Badge>
//                           )}
//                         </div>
//                       </div>
//                       <div>
...
//                           <Badge key={idx} size="md" variant="light" color="gray">✓ {qual.length > 30 ? qual.substring(0, 30) + '...' : qual}</Badge>
//                         ))}
//                       </div>
//                     </div>
