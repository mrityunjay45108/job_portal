...
export default function PostJobForm({ onSuccess }: { onSuccess?: () => void }) {
  ...
  const handleSubmit = async (values: JobFormValues) => {
    ...
    try {
      ...
      const recruiterJobs = existingRecruiterJobs
        ? JSON.parse(existingRecruiterJobs)
        : [];
      ...
      const notificationsList = existingNotifs
        ? JSON.parse(existingNotifs)
        : [];
      localStorage.setItem(
        "candidate_notifications",
        JSON.stringify([newNotification, ...notificationsList]),
      );
        ...
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <Text className="text-blue-100 max-w-2xl">
              Reach thousands of qualified candidates. Fill in the details below
              to create an impactful job posting that attracts top talent.
            </Text>
          </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Text size="sm" className="text-gray-600">
                      Use specific job titles like "Senior Frontend Developer"
                      instead of generic ones like "Developer" to attract the
                      right candidates. Include key technologies or seniority
                      levels.
                    </Text>
                  </div>
                </div>
                ...
                <Grid gutter="lg">
                  ...
                  <Grid.Col span={12}>
                    <div className="bg-gray-50 rounded-lg p-4">
                      <Text size="sm" fw={600} className="text-gray-700 mb-3">
                        Salary Range *
                      </Text>
              ...
              <div className="bg-gray-50 rounded-xl p-5">
                ...
                <div className="flex flex-wrap gap-6">
                  ...
                  <Switch
                    ...
                    onChange={(e) =>
                      form.setFieldValue("featuredJob", e.currentTarget.checked)
                    }
                    size="md"
                  />
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Text size="sm" className="text-gray-600">
                      ...
                      growth opportunities, and your company culture. Focus on
                      what makes your role unique and exciting.
                    </Text>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-5 border border-green-100">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <Text size="sm" className="text-gray-600">
                      Please carefully review all information before publishing.
                      Make sure everything is accurate and complete to attract
                      the best candidates.
                    </Text>
                  </div>
                </div>
