...
//   const getNavLinks = () => {
//     const commonLinks = [
//       { label: "Find Jobs", href: "/find-jobs", icon: <IconBriefcase size={18} /> }
//     ];
...
//       return [
//         ...commonLinks,
//         // { label: "Find Talent", href: "/find-talent", icon: <IconUser size={18} /> },
//         // { label: "Post a Job", href: "/post-job", icon: <IconBuilding size={18} /> },
//         { label: "My Jobs", href: "/Posted-Jobs", icon: <IconClipboardList size={18} /> },
//         { label: "Recruiter Dashboard", href: "/Recruiter-Dashboard", icon: <IconChartBar size={18} /> }
//       ];
//     }
...
//       {/* Center: Desktop Navigation - Role based */}
